    ...
    <div className="todo-container">
      ...
      <div className="lists-wrapper">
        <div className="panel todo">
          ...
          <div className="list">          
            {itemList.map((item, index)=>(               
              ...
              item.done===false?(<ListItem text={item.text} checked={item.done} key={`item-${index}`} /*onClick={()=>handleOnChangeItem(index, true)}*//>) :null                              
        ...
        <div className="panel done">
          ...
          <div className="list">
            { itemList.map(item=>( 
              item.done===true?(<ListItem text={item.text} checked={item.done}/>):null
            ))
